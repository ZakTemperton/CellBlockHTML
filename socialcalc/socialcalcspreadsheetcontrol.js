...
SocialCalc.SpreadsheetControl = function() {
    ...
    this.tabnums.html = this.tabs.length;
    this.tabs.push({name: "html", text: "HTML", html:
                    '<div id="%id.htmltools" style="display:none;">'+
                    '  <table cellspacing="0" cellpadding="0"><tr>'+
                    '   <td style="vertical-align:top;padding-right:24px;">'+
                    '    <div style="%tbt.">'+
                    '     &nbsp;'+
                    ...
                    '</div>',
                    view: "html",
                    onclick: SocialCalc.SpreadsheetControlHTMLOnClick,
                   });
    ...
    this.views["html"] = {name: "html", divStyle: "overflow:auto;", html:
                          ...
                          ' <br>'+
                          ' <input type="text" style="font-size:small;width:800px;" id="%id.myurl">'+
                          ' <br>'+
                          ' <textarea id="%id.mytext" style="font-size:small;height:350px;width:800px;overflow:auto;" onfocus="%s.CmdGotFocus(this);"></textarea>'+ 
                          '<br>'+
...
SocialCalc.SpreadSheetControlHTMLOnClick = function(s, t)
{
    var e = document.getElementById(s.idPrefix+"mytext");
    e.value = "";
    e.focus();
}

SocialCalc.SpreadsheetControlHTMLClear = function()
{
    var s = SocialCalc.GetSpreadsheetControlObject();
    var clipele = document.getElementById(s.idPrefix+"mytext");
    clipele.value = "";
    clipele.focus();
}

SocialCalc.SpreadsheetControlHTMLLoadURL = function()
{
    var s = SocialCalc.GetSpreadsheetControlObject();
    var url = document.getElementById(s.idPrefix+"myurl").value;
    $.getJSON('http://www.whateverorigin.org/get?url=' + encodeURIComponent(url) + '&callback=?', function(data)
              {
        var e = document.getElementById(s.idPrefix+"mytext");
        e.value = data.contents;
    });
}


SocialCalc.SpreadsheetControlHTMLLoadToCell = function()
{
    var s = SocialCalc.GetSpreadsheetControlObject();
    var e1 = document.getElementById(s.idPrefix+"mytext");
    var e2 = document.getElementById(s.idPrefix+"coord");
